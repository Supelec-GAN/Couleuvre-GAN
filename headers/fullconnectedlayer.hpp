...
class FullConnectedLayer : public NeuronLayer
{
    public:
         ...
         */
                        FullConnectedLayer(unsigned int inputSize, unsigned int outputSize, std::function<float(float)> activationF = Functions::sigmoid(10.f));
         ...
         * La matrice de poids est de dimension outputSize x inputSize
         */
                        FullConnectedLayer(unsigned int inputSize, unsigned int outputSize, Eigen::MatrixXf weight, Eigen::MatrixXf bias, std::function<float(float)> activationF = Functions::sigmoid(10.f));
